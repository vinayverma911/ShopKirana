...
<html lang="en">
    ...
    <div class="d-md-flex align-items-center">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            List<PreviousEmployment> lisofPreviousEmployment=new dao.PreviousEmployementDao().getPreviousEmployment(id);
                                            
                                            for(PreviousEmployment pem : lisofPreviousEmployment)
                                            {
                                            ...
                                            <table class="table v-middle">
                                                <thead>
                                                     <tr class="bg-light">
                                                         <th class="border-top-0"><h2><%=pem.getNameOfOrganization()%></h2></th>
                                                    </tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="">
                                                                    <h2 class="m-b-0 font-16">Designation</h2>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <label class="label label-danger" style="color: red"><%=pem.getDesignation()%></label>
                                                        <td></td>
                                                        <td></td>
                                                        <td>
                                                            <h5 class="m-b-0"></h5>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="">
                                                                    <h4 class="m-b-0 font-16">Date of Joining</h4>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <label class="label label-danger"><%= pem.getDateOfJoining() %></label>
                                                        <td></td>
                                                        <td></td>
                                                        <td>
                                                            <h5 class="m-b-0"></h5>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="">
                                                                    <h4 class="m-b-0 font-16">Date of Leaving</h4>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <label class="label label-danger"><%=pem.getDateOfLeaving()%></label>
                                                        <td></td>
                                                        <td></td>
                                                        <td>
                                                            <h5 class="m-b-0"></h5>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="">
                                                                    <h4 class="m-b-0 font-16">Address</h4>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <label class="label label-danger"> <%=pem.getAddress()%>  </label>
                                                        <td></td>
                                                        <td></td>
                                                        <td>
                                                            <h5 class="m-b-0"></h5>
